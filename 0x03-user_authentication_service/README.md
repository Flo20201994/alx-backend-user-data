...
0. User model
mandatory
In this task you will create a SQLAlchemy model named User for a database table named users (by using the mapping declaration of SQLAlchemy:https://docs.sqlalchemy.org/en/13/orm/tutorial.html#declare-a-mapping ).
